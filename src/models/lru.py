    ...
    def apply(
        ...
        *,
        ...
        features = LRURuntimeTensors(
            ...
            nonlinearity_jacobian_diag=jnp.ones_like(
                hidden_seq, dtype=self.param_dtype
            ),
        )
