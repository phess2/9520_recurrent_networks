#!/bin/bash
#SBATCH --job-name=hydra_dyck_sweep
...
python -m src.train.train_dyck --config-name dyck -m train.seed=0,1,2 model=lstm,elman,unitary,lru model.hidden_dim=32,64,128 optimizer.lr=1e-2,1e-3,5e-4
